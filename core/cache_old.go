...
func (od *OldOneDrive) PathToGraphAPIDriveItemsRequestURL(path string) string {
...
func (od *OldOneDrive) PathToGraphAPIDriveItemsPath(path string) string {
...
func (od *OldOneDrive) GraphAPIDriveItemsPathToPath(gPath string) string {
...
func (od *OldOneDrive) GetGraphAPIDriveItems(path string) (*GraphAPIDriveItems, error) {
...
func (od *OldOneDrive) GetGraphAPIDriveItemsRequest(reqURL string) (*GraphAPIDriveItems, error) {
...
func (od *OldOneDrive) GraphAPIDriveItemsToDriveItemsCache(graphAPIDriveItems *GraphAPIDriveItems) (*DriveItemsCache, error) {
...
func (od *OldOneDrive) GetGraphAPIDriveItemFromCache(path string) (*DriveItemsCache, error) {
...
func (od *OldOneDrive) GetGraphAPIDriveItemsFromCache(path string) (*DriveItemsCache, error) {
	path = od.PathToGraphAPIDriveItemsPath(path)
	for _, driveItemsCache := range od.DriveItemsCaches {
		driveItemsReference := driveItemsCache.DriveItemsReference
		if driveItemsReference.Path == path {
...
func (od *OldOneDrive) HitDriveItemsCaches(path string) (*DriveItemsCache, error) {
...
func (od *OldOneDrive) HitDriveItemCaches(path string) (*DriveItemsCache, error) {
	driveItemsCache, err := od.GetGraphAPIDriveItemFromCache(path)
	if err == nil {
		return driveItemsCache, nil
	}
...
func (od *OldOneDrive) HitDriveItemContentURLCaches(path string) (*url.URL, error) {
	driveItemsCache, err := od.HitDriveItemCaches(path)
	if err != nil {
		return nil, err
	}
...
func (od *OldOneDrive) CacheDrivePathContentURL(path string) (*url.URL, error) {
...
func (od *OldOneDrive) AutoCacheDrivePathContentURL(driveCache DriveCache) error {
...
func (od *OldOneDrive) getDriveCacheContentURL(reqURL string) (*DriveCacheContentURL, error) {
