...
// OldOneDrive presends a single OneDrive client end-point.
type OldOneDrive struct {
...
func (od *OldOneDrive) getMicrosoftGraphAPITokenPostForm() (io.Reader, error) {
	data := url.Values{}
...
func (od *OldOneDrive) GetMicrosoftGraphAPIToken() error {
...
func (od *OldOneDrive) DrivePathToURL(path string) string {
...
func (od *OldOneDrive) DrivePathContentToURL(path string) string {
	reqURL := od.DriveDescriptionConfig.EndPointURI
	reqURL += "/me"
	reqURL += RegularRootPath(od.DriveDescriptionConfig.RootPath)
...
func (od *OldOneDrive) GetDriveItemsFromRootPath() (*DriveItemsPayload, error) {
	return od.GetDriveItemsFromPath("")
}

func (od *OldOneDrive) GetDriveItemsFromPath(path string) (*DriveItemsPayload, error) {
...
func (od *OldOneDrive) GetDriveItemContentURLFromPath(path string) (*url.URL, error) {
